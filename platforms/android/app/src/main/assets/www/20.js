...
/* harmony import */ var _helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./helpers-dd7e4b7b.js */ "1vRN");
...
var createSwipeToCloseGesture = function createSwipeToCloseGesture(el, animation, onDismiss) {
  ...
  var onMove = function onMove(detail) {
    var step = Object(_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_14__["j"])(0.0001, detail.deltaY / height, 0.9999);
...
var computeDuration = function computeDuration(remaining, velocity) {
  return Object(_helpers_dd7e4b7b_js__WEBPACK_IMPORTED_MODULE_14__["j"])(400, remaining / Math.abs(velocity * 1.1), 500);
};
/**
...
var iosEnterAnimation = function iosEnterAnimation(baseEl, presentingEl) {
  var backdropAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_11__["c"])().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
  var wrapperAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_11__["c"])().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
    'opacity': 1
  }).fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
  var baseAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_11__["c"])().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation(wrapperAnimation);

  if (presentingEl) {
    var isMobile = window.innerWidth < 768;
    var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    var presentingAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_11__["c"])().beforeStyles({
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        var shadowAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_11__["c"])().afterStyles({
          'transform': _finalTransform
...
var iosLeaveAnimation = function iosLeaveAnimation(baseEl, presentingEl) {
  ...
  var backdropAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_11__["c"])().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 'var(--backdrop-opacity)', 0.0);
  var wrapperAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_11__["c"])().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
    'opacity': 1
  }).fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
  var baseAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_11__["c"])().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);

  if (presentingEl) {
    var isMobile = window.innerWidth < 768;
    var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    var presentingAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_11__["c"])().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(function (currentStep) {
    ...
    if (isMobile) {
      ...
      if (!hasCardModal) {
        ...
        var shadowAnimation = Object(_animation_096c6391_js__WEBPACK_IMPORTED_MODULE_11__["c"])().addElement(presentingEl.querySelector('.modal-shadow')).afterStyles({
          'transform': 'translateY(0) scale(1)'
        }).keyframes([{
          offset: 0,
          opacity: '0',
...
var Modal = /*#__PURE__*/function () {
  function Modal(hostRef) {
    ...
    Object(D_zizoe_Documents_ionic_github_restaurant_dashboard_main_node_modules_babel_runtime_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_3__["default"])(this, Modal);
  ...
  Object(D_zizoe_Documents_ionic_github_restaurant_dashboard_main_node_modules_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_4__["default"])(Modal, [{
    ...
    key: "present",
    value: function () {
      var _present2 = Object(D_zizoe_Documents_ionic_github_restaurant_dashboard_main_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/D_zizoe_Documents_ionic_github_restaurant_dashboard_main_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee() {
        var _this2 = this;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                _context.next = 8;
                return Object(_framework_delegate_4392cd63_js__WEBPACK_IMPORTED_MODULE_7__["a"])(this.delegate, container, this.component, ['ion-page'], componentProps);
              ...
              case 11:
                ...
                _context.next = 14;
                return Object(_overlays_e9ccff30_js__WEBPACK_IMPORTED_MODULE_8__["d"])(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, this.presentingElement);
    ...
    value: function initSwipeToClose() {
      ...
      this.gesture = createSwipeToCloseGesture(this.el, ani, function () {
        ...
        _this3.animation.onFinish( /*#__PURE__*/Object(D_zizoe_Documents_ionic_github_restaurant_dashboard_main_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/D_zizoe_Documents_ionic_github_restaurant_dashboard_main_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee2() {
    ...
    key: "dismiss",
    value: function () {
      var _dismiss2 = Object(D_zizoe_Documents_ionic_github_restaurant_dashboard_main_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__["default"])( /*#__PURE__*/D_zizoe_Documents_ionic_github_restaurant_dashboard_main_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.mark(function _callee3(data, role) {
        ...
        return D_zizoe_Documents_ionic_github_restaurant_dashboard_main_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                enteringAnimation = _overlays_e9ccff30_js__WEBPACK_IMPORTED_MODULE_8__["h"].get(this) || [];
                _context3.next = 5;
                return Object(_overlays_e9ccff30_js__WEBPACK_IMPORTED_MODULE_8__["f"])(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, this.presentingElement);
    ...
    value: function onDidDismiss() {
      return Object(_overlays_e9ccff30_js__WEBPACK_IMPORTED_MODULE_8__["g"])(this.el, 'ionModalDidDismiss');
    }
    /**
    ...
    value: function onWillDismiss() {
      return Object(_overlays_e9ccff30_js__WEBPACK_IMPORTED_MODULE_8__["g"])(this.el, 'ionModalWillDismiss');
    }
  }, {
    key: "render",
    value: function render() {
      ...
      return Object(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_5__["h"])(_index_7a8b7a1c_js__WEBPACK_IMPORTED_MODULE_5__["H"], Object.assign({
        ...
        class: Object.assign((_Object$assign = {}, Object(D_zizoe_Documents_ionic_github_restaurant_dashboard_main_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_Object$assign, mode, true), Object(D_zizoe_Documents_ionic_github_restaurant_dashboard_main_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_Object$assign, "modal-card", this.presentingElement !== undefined && mode === 'ios'), _Object$assign), Object(_theme_ff3fc52f_js__WEBPACK_IMPORTED_MODULE_9__["g"])(this.cssClass)),
